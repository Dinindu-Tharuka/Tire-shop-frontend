      ...
      <Flex>
        <Flex>
          {fields.map((field, creditIndex) => (
            <VStack align="start">
              <Input
                {...register(`payments_credit.${creditIndex}.bill_payment`)}
                placeholder="ID"
                type="number"
                defaultValue={creditIndex + 1}
              />
              <Input
                {...register(`payments_credit.${creditIndex}.payeename`)}
                placeholder="Payee Name"
                type="text"
              />
              <Input
                {...register(`payments_credit.${creditIndex}.amount`)}
                placeholder="Amount"
                type="number"
              />
              ...
              <Input
                {...register(`payments_credit.${creditIndex}.due_date`)}
                type="date"
              />
              {
                <Button
